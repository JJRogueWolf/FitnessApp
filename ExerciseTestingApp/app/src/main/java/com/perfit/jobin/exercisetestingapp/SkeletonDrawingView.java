...
public class SkeletonDrawingView extends View {
    ...
    public void drawSkeleton(Canvas canvas, SkeletonPoint[] skelPoints, Models model) {
        ...
        for(SkeletonPoint keypoint : skelPoints) {
            if(keypoint != null)
                canvas.drawCircle(keypoint.getPosition().x * xScaling, keypoint.getPosition().y * yScaling, 10, drawPaint);
        }
    }
