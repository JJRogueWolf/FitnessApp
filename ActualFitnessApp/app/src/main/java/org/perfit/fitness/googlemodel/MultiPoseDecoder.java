...
public class MultiPoseDecoder {
    ...
    private final PriorityBlockingQueue<PartScore> scoreQueue = new PriorityBlockingQueue<>(DEFAULT_QUEUE_SIZE, new Comparator<PartScore>() {
        @Override
    ...
    private final HeatmapScores heatmapScores;
    private final Offsets offsets;
    private final Displacements displacementsFwd;
    private final Displacements displacementsBwd;
