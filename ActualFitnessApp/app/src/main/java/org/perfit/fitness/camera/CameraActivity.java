...
import org.perfit.fitness.utilities.ImageUtils;
...
public abstract class CameraActivity extends AppCompatActivity
  ...
  Exercise exercise;
  SkeletonDrawingView skeletonDrawingView;
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    skeletonDrawingView = findViewById(R.id.skeletonDrawingView);

//    exercise = new Plank(this);
  ...
  void setCallback(final OverlayView.DrawCallback callback) {
    final OverlayView overlay = findViewById(R.id.debug_overlay);
    if (overlay != null) {
